...
async function getData(sheetsURL) {
  ...
  const grab = await external_axios_default()(gson);
  return grab.data; // return mock;
} // old gson link
...
class Hero_Hero extends external_react_["Component"] {
  ...
  render() {
    return Hero_jsx(external_react_["Fragment"], null, Hero_jsx("section", {
      id: "hero"
    }, Hero_jsx("h1", null, "AQ War Effort"), Hero_jsx("h3", null, "Deviate Delight"), Hero_jsx("h4", null, "Last Updated: ", this.props.date)));
  }
